class Pr003{
	public static void main(String args[]){
		...
		if(varb)
			System.out.println("Если varb==true ");
		varb=false;
		if(varb)
			System.out.println("Если varb==false");
		
		System.out.println("Результат сравнения 10>9: "+ (10>9));
	
		int_var = 0xFF; //16ричный формат числа 
		int int_var2= 023; //8ичный формат числа
		int int_var3= 0b00001000; //2ный формат 
		
		System.out.println("Значения: " + int_var + " "+ int_var2 + " " + int_var3);
		
		//Управляющие последовательности символов

		System.out.println("\nУправляющие последовательости: \n\\\'\tАпостроф\n\\\"\tДвойная кавычка\n\\r\tВозврат каретки");
